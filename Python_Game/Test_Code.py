...
class Bomb(pygame.sprite.Sprite):  
    def __init__(self, item, bomb):
        ...
        if self.y < HEIGHT:
            ...
            self.ydir = -1
        self.yv = self.ydir * random.randrange(4, 8)
...
def game():
    ...
    while True:
        ...
        if count % 60 == 0:
            ran = random.choice([1])
            new_bomb = Bomb(ran, bomb_img)
            bomb.append(new_bomb)
...
def main_menu():
    ...
    while True:
        ...
        START_BUTTON = Button(130, 350, "Button/Start_Button.png", "Button/Start_Button_Hover.png")
        QUIT_BUTTON =Button(130, 500, "Button/Quit_Button.png", "Button/Quit_Button_Hover.png")
...
you_died = pygame.transform.scale(pygame.image.load("dead.jpg"),(WIDTH, 775))
def GameOver():
    while True:
        ...
        QUIT_BUTTON =Button(475, 675, "Button/Quit_Button.png", "Button/Quit_Button_Hover.png")
